...
concepts in advanced statistical tests are similar.

If you need more information on any material covered here and much more
precise explanations than I could ever provide, please see [Dr. Steury’s
lectures](https://webhome.auburn.edu/~tds0009/wild7150.html).
...
``` r
bull.rich <- read.csv("data_files/Bull_richness.csv")
```
