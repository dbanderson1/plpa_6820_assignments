...
From the above table we see that “Treatment:DaysAfterPlanting p = 1\>.”
The interaction is not statistically significant (p=1), meaning the
effect of treatment does not depend on the day after planting.
Therefore, you can simplify the model and remove the interaction while
still keeping the main effects.
...
5 pts. Calculate the least square means for Treatment using the emmeans
...
![](coding_challenge_7_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->

Treatments that share at least one letter are NOT significantly
...
Commit, and push the .md file to github and turn in the .html, .docx, or
.pdf to Canvas. Provide me a link here to your github.
